...
/**
 * Represents a Three-Room flat in the system. Implements the {@link Flat} interface and provides methods
 * to retrieve flat details such as total units, booked units, and selling price. Also includes functionality
 * to book units and check availability.
 */
public class ThreeRoomFlat implements Flat {
    ...
    /**
     * Constructs a ThreeRoomFlat with the specified details.
     *
     ...
     */
    public ThreeRoomFlat(Flat.Type flatType, int totalUnits, int numOfBookedUnits, int sellingPrice) {
